                    ...
                    <div className="flex gap-10 font-monument">
                      {link.subLink.map((subLink) => (
                        ...
                        <div key={subLink.title} className="flex flex-row gap-10">
                          <a
                            href={subLink.link}
                            className="flex flex-col gap-4 items-center cursor-pointer transform transition duration-300 ease-in-out hover:scale-105 hover:rotate-1 hover:translate-y-2"
                          >
                            <div className="w-24">
