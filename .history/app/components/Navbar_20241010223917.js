...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <div className="absolute top-0 left-0 mt-10 w-48 bg-white p-4 rounded-lg shadow-lg opacity-0 -translate-y-5 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0 group-hover:flex hidden">
