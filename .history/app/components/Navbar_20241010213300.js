...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="mx-auto text-black bg-black/80 flex justify-between ">
          ...
          <div className="flex text-white">
            {links.map((link) => (
              <div key={link.title}>
                ...
                <div className="container mx-auto bg-white shadow-sm p-4 h-16  justify-center flex absolute z-10 bottom-0">
                  <div>
                    <ul className="">
                      <a>sddsdsd</a>
                      <a>sddsdsd</a>
