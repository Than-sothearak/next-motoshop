...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <div className="bg-white container mx-auto shadow-sm p-4 h-full  justify-center flex absolute z-20 top-16 right-0 left-0">
       <div>
       <div className="w-24">
        <img src="https://pngimg.com/uploads/motorcycle_helmets/motorcycle_helmets_PNG9630.png" alt=""/>
       </div>
       </div>
      </div>
      </nav>
